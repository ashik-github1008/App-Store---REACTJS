    ...
    return (
      <div className="app-container">
        <div className="main-container">
          <h1 className="heading mb-5">App Store</h1>
          <div className="input-container pl-2 pr-2 mb-4">
            <input
              placeholder="Search"
              type="search"
              className="input"
          ...
          <div className="app-items-container">
            <ul className="tab-container mb-4">
            ...
            <ul className="app-items-cards-container">
